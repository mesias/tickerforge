# TickerForge
**Derivatives Symbol Resolution Specification**
...
* 🐍 [**tickerforge-py**](https://github.com/mesias/tickerforge-py) — Python implementation *(Publishing soon to PyPI)*.
* 🦀 [**tickerforge-rs**](https://github.com/mesias/tickerforge-rs) — Rust implementation *(Publishing soon to crates.io)*.

*(Note: More language implementations may be added in the future.)*
